...
app.config['MYSQL_DATABASE_PASSWORD'] = 'yasin123'
...
# Write a function named `init_todo_db` create phonebook table within yasin_phonebook db, if it doesn't exist
...
def add_record():
    if request.method == 'POST':
        ...
        return render_template('add-update.html', show_result=True, result_html=result_app, not_valid=False, action_name='save', developer_name='Yasin') #In addition, There is no message shown by user here. Thats why not valid is going to be False.
    else:
...
def update_record():
    if request.method == 'POST':
        ...
        return render_template('add-update.html', show_result=True, result_html=result_app, not_valid=False, action_name='update', developer_name='Yasin') #Again, There is no message shown by user here. Thats why not valid is going to be False.
    else:
...
def delete_record():
    if request.method == 'POST':
        ...
        return render_template('delete.html', show_result=True, result_html=result_app, not_valid=False, developer_name='Yasin') # In addition, There will be no message to be shown to the user here. Thats why not valid is going to be False.
    else:
